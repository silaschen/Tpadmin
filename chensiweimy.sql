...
--
-- 表的结构 `bingo_art_category`
--

CREATE TABLE IF NOT EXISTS `bingo_art_category` (
...
CREATE TABLE IF NOT EXISTS `bingo_art_list` (
...
--
-- 表的结构 `bingo_cmd_audio`
--

CREATE TABLE IF NOT EXISTS `bingo_cmd_audio` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_cmd_count`
--

CREATE TABLE IF NOT EXISTS `bingo_cmd_count` (
...
--
-- 表的结构 `bingo_cmd_event`
--

CREATE TABLE IF NOT EXISTS `bingo_cmd_event` (
...
--
-- 表的结构 `bingo_cmd_location`
--

CREATE TABLE IF NOT EXISTS `bingo_cmd_location` (
...
--
-- 表的结构 `bingo_cmd_notfound`
--

CREATE TABLE IF NOT EXISTS `bingo_cmd_notfound` (
...
CREATE TABLE IF NOT EXISTS `bingo_cmd_pic` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `mod` varchar(50) DEFAULT NULL,
  `pre` varchar(50) DEFAULT NULL COMMENT '前置调用函数',
  `table` varchar(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bingo_cmd_text` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `mod` varchar(50) DEFAULT NULL,
  `pre` varchar(50) DEFAULT NULL COMMENT '前置调用函数',
...
CREATE TABLE IF NOT EXISTS `bingo_hpu_cate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bingo_hpu_stu` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_mate_audio`
--

CREATE TABLE IF NOT EXISTS `bingo_mate_audio` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_mate_morenews`
--

CREATE TABLE IF NOT EXISTS `bingo_mate_morenews` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_mate_onenews`
--

CREATE TABLE IF NOT EXISTS `bingo_mate_onenews` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(150) DEFAULT NULL,
...
--
-- 表的结构 `bingo_mate_remot`
--

CREATE TABLE IF NOT EXISTS `bingo_mate_remot` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_mate_text`
--

CREATE TABLE IF NOT EXISTS `bingo_mate_text` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bingo_mod_menu` (
...
--
-- 表的结构 `bingo_red_gotlog`
--

CREATE TABLE IF NOT EXISTS `bingo_red_gotlog` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bingo_red_logs` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_red_market`
--

CREATE TABLE IF NOT EXISTS `bingo_red_market` (
...
CREATE TABLE IF NOT EXISTS `bingo_red_pass` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `bingo_red_passlog`
--

CREATE TABLE IF NOT EXISTS `bingo_red_passlog` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bingo_red_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `openid` varchar(50) DEFAULT NULL,
...
--
-- 表的结构 `bingo_sys_location`
--

CREATE TABLE IF NOT EXISTS `bingo_sys_location` (
...
CREATE TABLE IF NOT EXISTS `bingo_sys_logs` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bingo_sys_role` (
  `id` tinyint(4) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bingo_sys_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `news_auth_group`
--

CREATE TABLE IF NOT EXISTS `news_auth_group` (
...
--
-- 表的结构 `news_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `news_auth_group_access` (
...
--
-- 转存表中的数据 `news_auth_group_access`
--
...
CREATE TABLE IF NOT EXISTS `news_auth_rule` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `news_essay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `news_lesson` (
...
(53, '鲁能赢球就保级', '鲁能赢球就能成功保级', '<p>哈哈哈</p>\n', '啊', 'admin', '山东鲁能', 12, 1, 'img/c.jpg', 0, '2016-10-16 10:27:18'),
(54, '今晚就看王大雷', '鲁能赢球就能成功保级', '<p>哈哈哈</p>\n', '啊', 'admin', '山东鲁能', 11, 1, 'img/c.jpg', 0, '2016-10-16 10:27:28'),
(55, '蒙蒂略首发 裴帅争首胜', '鲁能赢球就能成功保级', '<p>哈哈哈</p>\n', '啊', 'admin', '山东鲁能', 19, 1, 'img/c.jpg', 0, '2016-10-16 10:27:56');
...
CREATE TABLE IF NOT EXISTS `news_picnews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(30) DEFAULT NULL,
...
(11, 3, '上海申花', 26, 12, 5, 9, 44, 28, 16, 45),
...
CREATE TABLE IF NOT EXISTS `news_stu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `news_user` (`id`, `name`, `password`, `campus`, `head_pic`, `address`, `email`, `sign`, `create_time`) VALUES
(64, 'admin', 'admin', '马来西亚英迪国际学校', './uploads/2016-10-16/5802e6bfbdc26.jpg', '北京市', 'chern@sdfjkdfs.cc', '我要我成功', '2016-10-15 10:55:36'),
(65, '123', '123', '0', 'public/img/default.jpg', '0', NULL, '这家伙什么也没留下', '2016-11-18 15:07:57');
...
--
-- 表的结构 `news_videocomment`
--

CREATE TABLE IF NOT EXISTS `news_videocomment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `news_zan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `t_comment` (`id`, `parent_id`, `nickname`, `head_pic`, `content`, `create_time`) VALUES
(138, 0, '游客', '/Public/images/default.jpg', '今天天气好好哦!', '2015-05-17 17:36:12'),
(139, 138, '游客', '/Public/images/default.jpg', '很适合出去游玩', '2015-05-17 17:39:20'),
(140, 138, '游客', '/Public/images/default.jpg', '难得一见的一天呢', '2015-05-17 17:40:07'),
(141, 140, '游客', '/Public/images/default.jpg', '雾霾不见了 哈哈', '2015-05-17 17:58:45'),
(142, 0, '游客', '/Public/images/default.jpg', '今天适合去哪里玩呢', '2015-05-17 18:34:07'),
(143, 0, '游客', '/Public/images/default.jpg', '今天心情不错', '2015-05-17 20:17:37'),
(144, 0, '游客', '/Public/images/default.jpg', '哈哈哈', '2015-05-17 20:34:55'),
(145, 144, '游客', '/Public/images/default.jpg', '太棒了', '2015-05-17 20:35:09'),
(146, 144, '游客', '/Public/images/default.jpg', '好好的', '2015-05-17 20:35:15'),
(147, 146, '游客', '/Public/images/default.jpg', '哈哈哈', '2015-05-17 20:35:21'),
(148, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'hello i love u', '2016-09-29 16:35:42'),
(149, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'I wanna kiss u,', '2016-09-29 16:41:39'),
(150, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'asfdasdf', '2016-09-29 16:45:01'),
(151, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'fadasfaw', '2016-09-29 16:45:03'),
(152, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'fadfawef', '2016-09-29 16:45:04'),
(153, 0, '擎天柱', '__PUBLIC__/img/1.jpg', '按时', '2016-09-29 17:12:51'),
(154, 0, '擎天柱', '__PUBLIC__/img/1.jpg', '啊啊啊', '2016-09-29 17:15:53'),
(155, 0, '擎天柱', '__PUBLIC__/img/1.jpg', '阿萨斯', '2016-09-29 17:17:02'),
(156, 0, '擎天柱', '__PUBLIC__/img/1.jpg', '睡吧宝贝', '2016-09-29 17:17:08'),
(157, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'dsas', '2016-09-29 17:55:40'),
(158, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'a', '2016-09-29 18:09:03'),
(159, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'asdasd', '2016-09-29 22:46:57'),
(160, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'woaini', '2016-09-30 09:03:25'),
(161, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'woaini', '2016-09-30 09:03:32'),
(162, 0, '擎天柱', '__PUBLIC__/img/1.jpg', 'ssssssss', '2016-09-30 09:03:42'),
(163, 161, '擎天柱', '__PUBLIC__/img/1.jpg', '爱你麻痹', '2016-09-30 09:03:51'),
(164, 161, '擎天柱', '__PUBLIC__/img/1.jpg', 'sb', '2016-09-30 09:04:02'),
(165, 160, '擎天柱', '__PUBLIC__/img/1.jpg', 'hahhaha', '2016-09-30 09:04:09'),
(166, 162, '擎天柱', '__PUBLIC__/img/1.jpg', 'asddda', '2016-09-30 14:27:20'),
(167, 163, '擎天柱', '__PUBLIC__/img/1.jpg', 'nishi sb', '2016-09-30 14:27:31'),
(168, 163, '擎天柱', '__PUBLIC__/img/1.jpg', 'jjj', '2016-09-30 14:27:45'),
(169, 166, '擎天柱', '__PUBLIC__/img/1.jpg', 'hello', '2016-10-03 09:34:44');
