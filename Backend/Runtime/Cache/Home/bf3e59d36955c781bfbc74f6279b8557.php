  ...
  <form method="GET" action="<?php echo U('lesson/index');?>" id='form'>
	...
	<div class="col-md-12 ">
                ...
                <td><?php if($list["status"] == '0'): ?><span class="label label-danger">锁定</span><?php else: ?><span class="label label-success">正常</span><?php endif; ?></td>
                                            ...
                                            <td><a class="lesson-del btn btn-info"  lessonid="<?php echo ($list["id"]); ?>"><i class=" icon-trash"></i></a>&nbsp<a class="up btn btn-info"  uid="<?php echo ($list["id"]); ?>" href="<?php echo U('Index/addnode',array('id'=>$list['id']));?>"><i class="icon-edit"></i></a></td>
