...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="/foot/admin.php/home/user/logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
  ...
  <a href="<?php echo U('Access/addnode');?>" class="btn pull-right">add</a>
                ...
                <td><?php if($list["status"] == '0'): ?><span class="label label-danger">锁定</span><?php else: ?><span class="label label-success">正常</span><?php endif; ?></td>
                                            ...
                                            <a class="btn btn-info" id="edit" uid="<?php echo ($list["id"]); ?>" href="<?php echo U('Access/addrole',array('id'=>$list['id']));?>"><i class="icon-edit"></i></a>&nbsp
          ...
          <a class="btn btn-info" href="<?php echo U('Access/accessnode',array('id'=>$list['id']));?>"><i class="icon-user"></i></a>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
      function set(id,t)
      {
        ...
        if (r == true) {
            $.post("<?php echo U('Access/rolelist');?>",{id:id,t:t},function(data){

                  alert(data.msg);
                  location.href="<?php echo U('Access/rolelist');?>";
