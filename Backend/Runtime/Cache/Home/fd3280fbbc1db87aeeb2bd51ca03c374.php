...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="/foot/admin.php/home/user/logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody id="rank">
                                    <?php if(is_array($model)): foreach($model as $key=>$item): ?><tr del-id="<?php echo ($item["id"]); ?>">
                                           
                                            <td><?php echo ($item["id"]); ?></td>
                                            <td><?php echo ($item["clubname"]); ?></td>
                                            <td><?php echo ($item["score"]); ?></td>
                                            <td><?php echo ($item["rank"]); ?></td>
                                            <td><a class="rank-del btn btn-info" delid="<?php echo ($item["id"]); ?>" action="/foot/admin.php/home/rank/del"><i class=" icon-trash"></i></a>&nbsp<a href="/foot/admin.php/home/rank/update/id/<?php echo ($item["id"]); ?>" class="btn btn-info"><i class="icon-edit"></i></a></td>
    ...
    <div class="col-md-2"> <a href="/foot/admin.php/home/rank/add" class="btn btn-success">Add</a></div>
                 </div>
