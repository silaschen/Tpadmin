	...
	<div class="col-md-12 ">
                            ...
                            <div class="table table-bordered">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody id="lessonbody">
                                    <?php if(is_array($lesson)): foreach($lesson as $key=>$list): ?><tr delid="<?php echo ($list["id"]); ?>">
                                           
                                            <td><?php echo ($list["id"]); ?></td>
                                            <td><?php echo ($list["title"]); ?></td>
                                            <td><?php echo ($list["clubname"]); ?></td>

                <td><?php if($list["status"] == '0'): ?><span class="label label-danger">未发表</span><?php else: ?><span class="label label-success">已发表</span><?php endif; ?></td>

                                            <td><a class="lesson-del btn btn-info"  lessonid="<?php echo ($list["id"]); ?>"><i class=" icon-trash"></i></a>&nbsp<a class="up btn btn-info"  uid="<?php echo ($list["id"]); ?>" href="<?php echo U('lesson/add',array('id'=>$list['id']));?>"><i class="icon-edit"></i></a></td>
